this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Aa = ["letta", "renzi", "rumor", "rizzo", "amato", "parri", "lotti", "madia", "conte", "monti", "malan", "craxi", "bossi", "segre", "pella", "goria", "iotti", "cerno", "crimi", "leone", "segni", "prodi", "raggi", "bindi", "nenni", "razzi"],
      La = ["monti", "scoma", "leone", "pella", "goria", "iotti", "nenni", "segni", "prodi", "rumor", "rizzo", "amato", "parri", "raggi", "razzi", "bindi", "sasso", "liuni", "tasso", "nitti", "raffa", "boldi", "bondi", "curro", "pella", "nappi", "turri", "delia", "nardi", "bella", "frate", "billi", "ferro", "iorio", "gadda", "colla", "tateo", "lepri", "sisto", "sensi", "iezzi", "spena", "corda", "sorte", "penna", "mauri", "tucci", "costa", "lapia", "sarti", "menga", "ferri", "nesci", "tondo", "paxia", "fiano", "donno", "volpi", "braga", "torto", "trano", "vazio", "scanu", "silli", "galli", "berti", "rosso", "flati", "rotta", "bordo", "russo", "rossi", "butti", "dinca", "sutto", "marin", "gallo", "mammi", "sarli", "vinci", "vacca", "sapia", "madia", "siani", "manca", "bruno", "dieni", "ciaga", "manzo", "conte", "paita", "sarro", "rospi", "longo", "aprea", "marti", "doria", "rossi","manca","porta", "segre", "donno", "rauti", "drago", "vanin", "ortis", "cantu", "piano", "monti", "lanzi", "fusco", "romeo", "renzi", "morra", "turco", "botto", "lezzi", "iwobi", "pesco", "leone", "merlo", "faggi", "pirro", "cario", "cerno", "bossi", "abate", "craxi", "ferro", "crimi", "tesei", "marin", "malan", "zanda", "moles", "rampi", "corti"],
      Ta = "present",
      Ia = "correct",
      Ca = "absent";
  var Ma = {
  ...
  fs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Trova i <strong>Politici</strong> italiani tra quelli più noti o tra quelli eletti alla Camera o al Senato in questa legislatura il cui nome è composto da 5 lettere. Hai 6 tentativi in tutto.</p>\n      <p>Kasta è una versione modificata (non ufficiale) di <a href="https://powerlanguage.co.uk/wordle/">WORDLE</a> e della sua edizione italiana <a href="https://pietroppeter.github.io/wordle-it/">PARoLE</a> di cui riprende il codice. Solo che questa modifica è riservata ai fanatici di politica!</p>\n      <p>Dopo ogni tentativo, i colori delle tessere cambieranno per mostrarti quanto vicino sei andato a indovinare la parola.</p>\n      <div class="examples">\n        <div class="example">\n          <div class="row">\n            <game-tile letter="r" evaluation="correct" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="n"></game-tile>\n            <game-tile letter="z"></game-tile>\n            <game-tile letter="i"></game-tile>\n          </div>\n          <p>La lettera <strong>R</strong> è nella parola ed è nel posto giusto.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="l"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="t" evaluation="present" reveal></game-tile>\n            <game-tile letter="t"></game-tile>\n            <game-tile letter="a"></game-tile>\n          </div>\n          <p>La lettera <strong>T</strong> è nella parola ma nel posto sbagliato.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="r"></game-tile>\n            <game-tile letter="i"></game-tile>\n            <game-tile letter="m" evaluation="absent" reveal></game-tile>\n            <game-tile letter="i"></game-tile>\n          </div>\n          <p>La lettera <strong>M</strong> non è nella parola.</p>\n        </div>\n      </div>\n      <p>Torna anche domani! Ogni giorno <strong>un politico</strong> diverso</p>\n   <p>Ideato da <a href="https://twitter.com/mauromunafo"><strong>Mauro Munafò</strong></a> </p>\n   </div>\n  </section>\n';
  var ks = function(e) {
      n(t, e);
      var a = h(t);
